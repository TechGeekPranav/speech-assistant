...
def respond(voice_data):
    ...
    if there_exists(['make a note', 'write something down', 'i want to take a note']):
    ...
    if there_exists(['open notepad', 'open note']):
    ...
    if there_exists(["i need the definition of", 'find wikipedia for', 'i need to do some research', 'can you find wikipedia for']):
