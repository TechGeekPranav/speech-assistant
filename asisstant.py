...
def respond(voice_data):
    ...
    if there_exists(['what can you do', 'how can you help me', 'tell me about you', 'can you tell me what you can do']):
        ...
        engine_speak('I can help you to search google, wikipedia or youtube. I can tell you the weather, the price of something, or the time. I can make a note for you, take a screenshot, play a game with you, play a song for you, and make you laugh.')
    # 2. greetings
    ...
    if there_exists(["suggest me a book", "i am bored", "tell me a book that i should read", "book for pleasure reading", "book to improve vocabulary"]):
            book_suggestions = "Inheritance Cycle-Cristopher Paolini,\nHarry Potter-J.K Rowling,\nHit Refresh-Satya Nadella,\nSwiss Family Robinson-Johann David Wyss,\nKensuke's Kingdom-Michael Morpurgo"
            file_name = "Alexis Books.txt"
            with open(file_name, "w") as f:
                f.write(book_suggestions)
            engine_speak("I have saved the recommendations to your current directory")

    # 2: greeting
    if there_exists(["how are you","how are you doing"]):
        engine_speak("I'm very well, thanks for asking " + person_obj.name)

    if there_exists(["joke","riddle","laugh","fun"]):
    ...
    # 6. taking a note
    if there_exists(['make a note', 'write something down', 'i want to take a note', 'can you write something down', 'take a note', 'note', 'help me rememver something']):
    ...
    if there_exists(["capture","my screen","screenshot"]):
        ...
        myScreenshot.save('Alexis_Screenshot.png')
        engine_speak('Screenshot taken and saved ')

    if there_exists(["play","song"]):
        song = voice_data.replace("play", "")
        engine_speak('Playing ' + song)
        pywhatkit.playonyt(song)
        engine_speak("I will exit listening mode. Please run me again if you need me")
        exit()
    ...
    #3. name
    if there_exists(["who are you", 'what are you', 'who you are']):
        
        engine_speak('I am Alexis. Your personal voice assistant')

    if there_exists(['who built you','who is your boss','who created you','founder']):
        engine_speak('I was built by Pranav')
